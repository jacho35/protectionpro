...
const COMPONENT_DEFS = {
  ...
  utility: {
    ...
    fields: [
      ...
      { key: 'z2_z1_ratio', label: 'Z₂/Z₁ Ratio', type: 'number', min: 0.5, max: 2, step: 0.1 },
      { key: 'z0_z1_ratio', label: 'Z₀/Z₁ Ratio', type: 'number', min: 0.5, max: 5, step: 0.1 },
      { key: 'x0_r0_ratio', label: 'X₀/R₀ Ratio', type: 'number' },
    ],
  },
  generator: {
    name: 'Generator',
    ...
    fields: [
      ...
      { key: 'x2', label: 'X₂ (neg. seq.)', type: 'number', unit: 'p.u.' },
      { key: 'x0', label: 'X₀ (zero seq.)', type: 'number', unit: 'p.u.' },
      { key: 'x_r_ratio', label: 'X/R Ratio', type: 'number' },
  ...
  cable: {
    ...
    fields: [
      ...
      { key: 'ampacity_standard', label: 'Ampacity Standard', type: 'select', options: ['IEC', 'NEC'] },
      ...
      { key: 'r_per_km', label: 'R₁ (pos. seq.)', type: 'number', unit: 'Ω/km' },
      { key: 'x_per_km', label: 'X₁ (pos. seq.)', type: 'number', unit: 'Ω/km' },
      { key: 'r0_per_km', label: 'R₀ (zero seq.)', type: 'number', unit: 'Ω/km', min: 0, step: 0.001 },
      { key: 'x0_per_km', label: 'X₀ (zero seq.)', type: 'number', unit: 'Ω/km', min: 0, step: 0.001 },
      { key: 'r2_per_km', label: 'R₂ (neg. seq.)', type: 'number', unit: 'Ω/km', min: 0, step: 0.001 },
      { key: 'x2_per_km', label: 'X₂ (neg. seq.)', type: 'number', unit: 'Ω/km', min: 0, step: 0.001 },
